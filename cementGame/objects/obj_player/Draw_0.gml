...
var scCrop=min(max(0,scHeight/2+(x-2906)),scHeight);
draw_sprite_part_ext(spr_screen,0,0,scHeight-scCrop,sprite_get_width(spr_screen),scHeight,x,y,1,1,c_white,1);
